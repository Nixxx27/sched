    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumbs">
                ...
                <li class="active">
                    <i class="fa fa-bookmark"></i> Add Schedule
                </li>
            </ol>
        </div>
    </div> <!-- /.row -->
    <div class="row">
        <div class="col-md-4">
            <div class="example" data-text="">
                <div class="grid">
                    {!! Form::open(array('name'=>'add_season','id'=>'add_season','action'=>'ScheduleController@store')) !!}
                    @include('errors.list')
                    <div class="row cells">
                        <div class="cell">
                            <label>Sched Name:</label>
                            <div class="input-control text full-size {{ $errors->has('sched_num')?  ' error block-shadow-danger' : '' }}">
                                <input type="text" name="sched_num" value="{{old('sched_num')}}">
                            </div>
                        </div>
                  </div>
